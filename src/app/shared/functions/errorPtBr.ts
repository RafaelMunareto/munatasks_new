...
export class ErrorPtBr {
  constructor(private overlayService: OverlayService) {}

  async erro(e: any) {
    return await this.overlayService.toast({
      message: this.verificaCodeErro(e.code),
    });
  }

  changeErrorBiometric(erro) {
    switch (erro) {
      case 'No credentials found':
  ...
  verificaCodeErro(errorCode: string): string {
    switch (errorCode) {
